      ...
      <div className="fade-up">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-sm text-slate-500 font-bold mt-1 ml-[60px]">Sistem Pengarsipan Surat & Proposal Pondok</p>
          </div>
          
          <button 
            onClick={() => setIsModalOpen(true)}
            className="flex items-center justify-center gap-2 px-6 py-4 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-black rounded-2xl transition-all shadow-xl shadow-indigo-600/20 active:scale-95"
          >
          ...
          <div className="p-6 border-b border-slate-50 bg-slate-50/30 flex flex-col md:flex-row items-center gap-4">
            <div className="relative flex-1 w-full">
              ...
              <input 
                ...
                className="w-full pl-11 pr-4 py-3 bg-white border border-slate-200 rounded-2xl text-sm font-bold focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/5 outline-none transition-all"
                value={searchQuery}
            ...
            <div className="flex items-center gap-2 w-full md:w-auto">
              ...
              <div className="flex bg-white rounded-xl border border-slate-200 p-1 flex-1 md:flex-none">
                {["Semua", "Masuk", "Keluar"].map((t) => (
                  <button
                    key={t}
                    onClick={() => setFilterType(t)}
                    className={`flex-1 md:flex-none px-4 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wider transition-all ${
                        filterType === t 
