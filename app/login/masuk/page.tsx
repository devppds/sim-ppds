    ...
    <>
      ...
      <div className="fixed inset-0 bg-[#021c14] overflow-y-auto selection:bg-amber-500/30">
        ...
        <div className="absolute top-6 left-6 z-20">
          <Link 
            href="/login"
            className="flex items-center gap-2 text-amber-500/70 hover:text-amber-400 transition-colors text-sm font-bold bg-[#064e3b]/50 py-2 px-4 rounded-full border border-amber-500/20 backdrop-blur-md"
          >
